...
nwframe = LabelFrame(root,text="Konversi Suhu",padx=10,pady=10)
...
rmslbl = Label(nwframe,text="Rumus : ",bg="magenta")
...
def rumus(rm):
    ...
    if kotaksatu == "celcius" and kotakdua == "fahrentheit":
        ...
        rmsnya = Label(nwframe,text=e1.get()+"°C + 273 = ... K")
        hitungan = (nomer1 + 273)
        ...
        rmsnya = Label(nwframe,text="("+e1.get()+"°F - 32) × 5/9 + 273 = ... K")
        hitungan = (nomer1 - 32) * 5/9 + 273
        ...
        rmsnya = Label(nwframe,text=e1.get()+"K - 273 = ... °C")
        hitungan = (nomer1 - 273)
    elif kotaksatu == "kelvin" and kotakdua == "fahrentheit":
        rmsnya = Label(nwframe,text="("+e1.get()+"K - 273) × 9/5 + 32 = ... °F ")
        hitungan = (nomer1 - 273) * 9/5 + 32 
...
btn = Button(nwframe,text="Konversi",command=lambda:rumus("hitung"))
