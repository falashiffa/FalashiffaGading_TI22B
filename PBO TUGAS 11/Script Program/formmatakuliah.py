...
class FormMatakuliah:
    ...
    def aturKomponen(self):
        ...
        self.tree.column('kodemk', width="100")
    ...
    def onCari(self, event=None):
        ...
        rec = mk.affected
        if (rec > 0):
            messagebox.showinfo("showinfo", "Mata Kuliah Ditemukan")
            self.TampilkanData()
            self.ditemukan = True
        else:
    ...
    def onDelete(self, event=None):
        ...
        if rec > 0:
            ...
            confirm = messagebox.askyesno(
                "Konfirmasi", "Apakah Anda yakin ingin menghapus Mata Kuliah ini ?")
            if confirm:
